...
public class PathfinderGoalFollowZombOwner extends PathfinderGoal {
	...
	public PathfinderGoalFollowZombOwner(ZombieType paramEntityTameableAnimal, double paramDouble, float paramFloat1, float paramFloat2, boolean hero) {
...
//		}
	...
	public boolean b() {
		if (herobrine) {
			return (!this.g.g()) && ((this.d.f(this.e) > this.b * this.b) || (this.d.f(this.e) < this.c * this.c)) && (!this.d.isSitting());
		} else {
	...
	public void e() {
		...
		if (!this.herobrine) {
			...
			float dst = (float) this.d.f(this.e);
			float min = this.b;
			float max = this.c;
//			System.out.print("dst: "+dst+" - min: " + (min*min) + " - max: "+(max*max));
			...
			for (int n = 0; n <= 4; n++) {
				for (int i1 = 0; i1 <= 4; i1++) {
					if ((n < 1) || (i1 < 1) || (n > 3) || (i1 > 3)) {
						if ((World.a(this.a, x + n, y - 1, z + i1)) && (!this.a.getType(x + n, y, z + i1).r()) && (!this.a.getType(x + n, y + 1, z + i1).r())) {
