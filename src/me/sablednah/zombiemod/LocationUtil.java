...
public class LocationUtil {
        ...
        while (isBlockUnsafe(world, x, y, z)) {
            ...
            if (y <= 1) {
                ...
                if (x - 48 > loc.getBlockX()) {
                    throw new Exception(("§4Hole in floor!"));
                }
            }
        }
    ...
    public static boolean isBlockDamaging(final World world, final int x, final int y, final int z) {
        ...
        if ((!AIR_MATERIALS.contains(world.getBlockAt(x, y, z).getType().getId())) || (!AIR_MATERIALS.contains(world.getBlockAt(x, y + 1, z).getType().getId()))) {
            return true;
        }
        return false;
    }
