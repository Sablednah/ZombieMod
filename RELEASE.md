...
|---|---|
| Tag | `v3.2.0` |
| Title | `3.2.0 — Minecraft 26.1 and 26.2` |
| Body | The `## 3.2.0` section of [`CHANGELOG.md`](CHANGELOG.md), plus the requirements table below |
...
| Changelog | The `## 3.2.0` section of [`CHANGELOG.md`](CHANGELOG.md) |
...
- [ ] `./gradlew build` and confirm the jars are `zombiemod-3.2.0+mc<version>.jar`, one per supported Minecraft version
...
- [ ] Push `master`, `mc26.1`, `mc26.2` and the `v3.2.0` tag
