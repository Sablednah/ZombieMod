...
|---|---|
| Tag | `v3.1.1` |
| Title | `3.1.1 — The Undertow actually swims` |
| Body | The `## 3.1.1` section of [`CHANGELOG.md`](CHANGELOG.md), plus the requirements table below |
...
| Changelog | The `## 3.1.1` section of [`CHANGELOG.md`](CHANGELOG.md) |
...
- [ ] `./gradlew build` and confirm the jar is `zombiemod-3.1.1.jar`
...
- [ ] Push `master` and the `v3.1.1` tag
